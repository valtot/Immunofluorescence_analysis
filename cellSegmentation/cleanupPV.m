function binarized = cleanupPV(binarized)
%CLEANUPPV Summary of this function goes here
...
if sum(binarized(:)) > 30
    ...
    binarized = imdilate(binarized,strel('disk',4));
    binarized = bwmorph(binarized,'majority',1);
    binarized = bwmorph(binarized,'fill',7);
